...
export const ALL_COMMANDS: CommandDefinition[] = [
  ...
  tool("tool-ellipse", "Select Ellipse tool", "Draw ellipses", "ellipse", "O"),
  tool("tool-line", "Select Line tool", "Draw lines", "line", "L"),
  tool("tool-arrow", "Select Arrow tool", "Draw arrows", "arrow", "⇧L"),
  tool("tool-pencil", "Select Pencil tool", "Freehand strokes", "pencil", "⇧P"),
  tool("tool-polygon", "Select Polygon tool", "Draw polygons", "polygon", ""),
  tool("tool-star", "Select Star tool", "Draw stars", "star", ""),
  tool("tool-triangle", "Select Triangle tool", "Draw triangles", "triangle", ""),
  tool("tool-pen", "Select Pen tool", "Vector paths", "pen", "P"),
  tool("tool-text", "Select Text tool", "Point text", "text", "T"),
  tool("tool-comment", "Select Comment tool", "Place a comment pin", "comment", "C"),
  ...
  },
  {
    ...
    subtitle: "Wrap selection in a plain frame (Figma ⌘⌥G)",
    category: "Actions",
    shortcut: "⌘⌥G",
    keywords: ["frame", "wrap", "section"],
    enabled: (s) => inDesign(s) && canAddAutoLayoutToSelection(s.selectedIds, s.nodes),
    run: (s) => s.wrapSelectionInFrame(),
  },
  {
    id: "add-auto-layout",
