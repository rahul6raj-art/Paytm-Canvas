...
import { TypographyLibraryPickerBody } from "./TypographyLibraryPickerBody";
...
type TypographyLibraryDialogProps = {
  open: boolean;
  onClose: () => void;
...
export function TypographyLibraryDialog({
  open,
  onClose,
  anchorRef,
  title = "Text styles",
  activeTokenId,
  onPick,
}: TypographyLibraryDialogProps) {
  const [mounted, setMounted] = useState(false);
  const [view, setView] = useState<TypographyLibraryView>("list");
  ...
  const styles = getTypographyDesignTokens(designTokens);
