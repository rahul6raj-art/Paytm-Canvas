...
import { isGithubOAuthDevMockEnabled } from "./devMockGithub";
...
export function readOAuthProvidersStatus(): OAuthProvidersStatus {
  return {
    google: isGoogleOAuthConfigured() || isGoogleOAuthDevMockEnabled(),
    github: isGithubOAuthConfigured() || isGithubOAuthDevMockEnabled(),
  };
}
